...
class KarelFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.kprogram = StyledTextCtrl(self.keditorzone)
        self.notebook_1 = wx.Notebook(self.keditorzone, -1, style=0)
        self.notebook_1_pane_1 = wx.Panel(self.notebook_1, -1)
        self.notebook_1_pane_2 = wx.Panel(self.notebook_1, -1)
        self.kworld = wx.Panel(self.kseparator, -1)
    ...
    def __set_properties(self):
        ...
        self.kworld.SetBackgroundColour(wx.SystemSettings_GetColour(wx.SYS_COLOUR_BTNHILIGHT))
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        self.kseparator.SplitVertically(self.keditorzone, self.kworld, 372)
