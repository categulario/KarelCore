...
class KarelFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Nuevo"), wx.Bitmap("images/document-new.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/document-new.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Nuevo programa"), _("Crea un nuevo programa"))
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Abrir"), wx.Bitmap("images/document-open.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/document-open.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Abrir programa"), _("Abre un archivo de programa"))
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Guardar"), wx.Bitmap("images/document-save.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/document-save.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Guardar programa"), _("Guarda el programa a un archivo"))
        self.kframe_toolbar.AddSeparator()
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Nuevo"), wx.Bitmap("images/world-new.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/world-new.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Nuevo mundo"), _("Crea un nuevo mundo donde todo es felicidad"))
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Abrir"), wx.Bitmap("images/world-open.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/world-open.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Abre un mundo"), _("Entra a un mundo desconocido"))
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Guardar"), wx.Bitmap("images/world-save.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/world-save.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Salva el mundo"), _(u"Salva el mundo de la destrucción"))
        self.kframe_toolbar.AddSeparator()
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Regresar"), wx.Bitmap("images/view-refresh.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/view-refresh.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Regresar al estado original"), _("Regresa el mundo y el programa a su estado original"))
        self.kframe_toolbar.AddSeparator()
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Compilar"), wx.Bitmap("images/applications-system.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/applications-system.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Compilar programa"), _("Compila el programa"))
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Correr"), wx.Bitmap("images/media-playback-start.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/media-playback-start.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Ejecutar programa"), _("Ejecuta el programa en el mundo"))
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Atras"), wx.Bitmap("images/media-seek-backward.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/media-seek-backward.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Retrocede"), _(u"Retroceder en le ejecución"))
        self.kframe_toolbar.AddLabelTool(wx.NewId(), _("Adelante"), wx.Bitmap("images/media-seek-forward.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("images/media-seek-forward.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _("Avanza"), _(u"Avanza en la ejecución"))
        # Tool Bar end
